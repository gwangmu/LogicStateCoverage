...
be left. This roughly translates to $\Pr(\mathrm{abnormal} \mid \mathrm{new})$
...
in a larger $\Pr(\mathrm{abnormal} \mid \mathrm{new})$ at the beginning that slowly
decreases over time. 
...
factors that affects $\Pr(\mathrm{abnormal})$ (e.g., freshness of code).  A
